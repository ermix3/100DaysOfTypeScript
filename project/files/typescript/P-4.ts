...
function showTypes<T, R=number, S=boolean>(one?: T, two?: R, three?: S): string {
  if (one) {
...
// Do Not Edit Here
let gameOne = new Game2<string|number>("Ys", 100);
let gameTwo = new Game2<number>(2064, 100); // There's A Game Called "2064"
